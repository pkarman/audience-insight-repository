...
is( $counts['src_export_mailchimp'], 1, 'reader - src_export_mailchimp' );
...
is( $counts['src_export_mailchimp'], 1, 'writer - src_export_mailchimp' );
...
is( $counts['src_export_mailchimp'], 0, 'freemium - src_export_mailchimp' );
